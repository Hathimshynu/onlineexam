<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="light" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable" data-layout-mode="light" data-layout-width="fluid" data-layout-position="fixed" data-layout-style="default">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-2 text-white-50">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-6">
                                    <p style="color:#ffffffc7;" class="mt-3 fs-18 fw-medium">"Logout Successful! We appreciate your trust in our services. Have a fantastic day!"</p>
                                </div>
                            </div>
                        </div>
                    </div>
